...
locals {
  ...
  # Build ECS task environment from non-empty values only
  _all_env = [
    { name = "PORT",    value = tostring(var.app_port) },
    { name = "APP_ENV", value = "production" },
    { name = "DATABASE_URL",              value = local._db_url },
    { name = "DB_HOST",                   value = local._db_host },
    { name = "DB_PORT",                   value = local._db_port },
    { name = "DB_NAME",                   value = local._db_name },
    { name = "DB_USER",                   value = local._db_user },
    { name = "DB_PASSWORD",               value = local._db_password },
